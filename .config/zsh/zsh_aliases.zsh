...
alias zcf="vim ~/.zshrc"
alias acf="vim ~/.config/alacritty/alacritty.toml"
alias rcf="vim ~/.config/ranger/rc.conf"
alias sv='sudo -E nvim'
alias l='cd - >/dev/null'
alias curl='curl --silent --show-error'
alias hg='history | grep'
alias ls='eza -s=name --icons --color=always --group-directories-first'
alias la='ls -a'
alias ll='eza -lamgh -s=name --icons --color-scale --group-directories-first'
alias tree='eza -lamghT --icons --color-scale --group-directories-first'
