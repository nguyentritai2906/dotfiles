...
" Configs
    ...
    source ~/.config/nvim/config/expand-region.vim
    ...
    source ~/.config/nvim/config/ipython-cell.vim
    source ~/.config/nvim/config/is.vim
    ...
    source ~/.config/nvim/config/nvim-treesitter.lua
    source ~/.config/nvim/config/prettier.vim
    source ~/.config/nvim/config/quick-scope.vim
