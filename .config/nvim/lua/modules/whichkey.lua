...
wk.register({
    ...
    d = {
        ...
        B = {"<cmd>lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<CR>", "ConditionalBreakpoint"},
        E = {"<cmd>lua require'dap'.set_exception_breakpoints({'all'})<CR>", "ExceptionBreakpoint"},
        h = {"<cmd>lua require'dap'.step_out()<CR>", "StepOut"},
        l = {"<cmd>lua require'dap'.step_into()<CR>", "StepInto"},
        j = {"<cmd>lua require'dap'.step_back()<CR>", "StepBack"},
        k = {"<cmd>lua require'dap'.step_over()<CR>", "StepOver"},
        d = {"<cmd>lua require'dap'.continue()<CR>", "Continue"},
        c = {"<cmd>lua require'dap'.run_to_cursor()<CR>", "RunToCursor"},
        q = {"<cmd>lua require'dap'.disconnect({ terminateDebuggee = true });require'dap'.close()<CR>", "Quit"},
        K = {"<cmd>lua require'dap'.up()<CR>", "Up"},
        J = {"<cmd>lua require'dap'.down()<CR>", "Down"},
        e = {"<cmd>lua require('dapui').eval()<CR>", "Evaluate"},
        u = {"<cmd>lua require('dapui').toggle()<CR>", "ToggleUI"},
        i = {
            name = "+Info",
            i = {"<cmd>lua require('dapui').float_element()<CR>", "Interactive"},
            b = {"<cmd>lua require('dapui').float_element('breakpoints')<CR>", "Breakpoint"},
            r = {"<cmd>lua require('dapui').float_element('repl')<CR>", "REPL"},
            s = {"<cmd>lua require('dapui').float_element('scopes')<CR>", "Scope"},
            t = {"<cmd>lua require('dapui').float_element('stacks')<CR>", "Stack"},
            w = {"<cmd>lua require('dapui').float_element('watches')<CR>", "Watch"},
        },
    },
},
{
